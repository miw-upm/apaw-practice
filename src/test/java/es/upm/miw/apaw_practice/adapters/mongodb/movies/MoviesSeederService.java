...
public class MoviesSeederService {
    ...
    public void seedDatabase() {
        ...
        Set<ActorEntity> actorsForInception = new HashSet<>(Set.of(actors[0]));
        ...
        MovieEntity[] movies = {
                new MovieEntity("tt1375666", "Inception", new BigDecimal("292587330"), LocalDate.of(2010, 7, 8), actorsForInception, awards[1]),
                ...
                new MovieEntity("tt7654321", "The Avengers: Reassemble", new BigDecimal("1200000000"), LocalDate.of(2023, 5, 1), new HashSet<>(), awards[3])
        };
