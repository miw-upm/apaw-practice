...
class TutoringSessionRepositoryIT {
    ...
    @Test
    void findByTitle(){
        assertTrue(this.tutoringSessionRepository.findByTitle("Lenguaje C Básico 1").isPresent());
        TutoringSessionEntity tutoringSession = this.tutoringSessionRepository.findByTitle("Lenguaje C Básico 1").get();
        assertEquals("Lenguaje C Básico 1", tutoringSession.getTitle());
