...
// Create appointment entities
            AppointmentEntity[] appointments = {
                    new AppointmentEntity("H001", LocalDate.of(2024, 10, 20), LocalTime.of(10, 0), "Room 101");
                    new AppointmentEntity("H002", LocalDate.of(2024, 10, 20), LocalTime.of(10, 0), "Room 102");
                    new AppointmentEntity("H002", LocalDate.of(2024, 10, 20), LocalTime.of(10, 0), "Room 102");
            };
