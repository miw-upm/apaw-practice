...
class SportModalityRepositoryIT {
    ...
    void testFindBySportId() {
        assertTrue(this.sportModalityRepository.findById(UUID.fromString("aaaaaaaa-bbbb-cccc-dddd-eeeeffff0007")).isPresent());
        var sportModality = this.sportModalityRepository.findById(UUID.fromString("aaaaaaaa-bbbb-cccc-dddd-eeeeffff0007")).get();
        assertThat(sportModality).isNotNull();
        assertThat(sportModality.getId()).isEqualTo(UUID.fromString("aaaaaaaa-bbbb-cccc-dddd-eeeeffff0007"));
