...
public class CreditCardEntity {
    ...
    public CreditCardEntity (CreditCard creditCard){
        BeanUtils.copyProperties(creditCard, this);
        this.paymentHistoryList = creditCard.getPaymentHistoryList()
                .stream()
                .map(PaymentHistoryEntity::new)
                .toList();
    }
