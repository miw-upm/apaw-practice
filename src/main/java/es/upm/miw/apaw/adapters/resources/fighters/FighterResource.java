...
public class FighterResource {
    ...
    public record CommentsDto(List<String> comments) {}
    @Autowired
    ...
    @GetMapping("/ratings-distinct-by-academy")
    public CommentsDto findDistinctCommentsByAcademy(@RequestParam String academy) {
        return new CommentsDto(this.fighterService.findDistinctCommentsByAcademy(academy));
    }
}
